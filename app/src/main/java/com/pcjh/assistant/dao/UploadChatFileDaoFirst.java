...
public class UploadChatFileDaoFirst extends IDao {
    ...
    public UploadChatFileDaoFirst(Context context, INetResult iNetResult) {
    ...
    public void uploadChatFile (String wx , String token , File file ,String flag){
        ...
        postRequest(Constant.BASE_URL+Constant.UPLOAD_CHAT_FILE, requestParams,RequestCode.UPLOADFILE1);
    }
