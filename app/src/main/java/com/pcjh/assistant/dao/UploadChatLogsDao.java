...
public class UploadChatLogsDao extends IDao {
    ...
    public void uploadChatLogs(String wx , String token , String json  ){
        RequestParams requestParams =new RequestParams();
        requestParams.add("wx",wx);
        requestParams.add("token",token);
        requestParams.add("chat_logs",json);
        postRequest(Constant.BASE_URL+Constant.UPLOAD_CHAT_LOGS ,requestParams, RequestCode.UPLOADTEXT);
    }
    @Override
