package com.pcjh.liabrary.tablayout;
...
import com.pcjh.liabrary.tablayout.utils.UnreadMsgUtils;
import com.pcjh.liabrary.tablayout.widget.MsgView;
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
            ...
            float textWidth = mTextPaint.measureText(tab_title.getText().toString())*7/5;
        ...
        if (this.mCurrentTab < mTabCount - 1) {
            ...
            if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
                ...
                mTextPaint.setTextSize(mTextsize);
                float nextTextWidth = mTextPaint.measureText(next_tab_title.getText().toString())*7/5;
